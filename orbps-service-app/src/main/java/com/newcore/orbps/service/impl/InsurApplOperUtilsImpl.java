 ...
 */
@Service("insurApplLandUtils")
public class InsurApplOperUtilsImpl implements InsurApplOperUtils {
    ...
    public RetInfo getIsInsurApplLanding(String applNo) {
        ...
        if (StringUtils.equals("C", taskCntrDataLandingQueue.getStatus()) //落地批作业已经完成
            ...
            if (StringUtils.equals(taskCntrDataLandingQueue.getIsCommonAgreement(), YES_NO_FLAG.YES.getKey())) {
                ...
                if (!StringUtils.equals(SUCESS_LAND_STATUS, taskCntrDataLandingQueue.getPlnLandFlag())) {
                    retInfo.setRetCode("2");
                    return retInfo;
                }
    		...
    		// 获取团单基本信息
            if (StringUtils.equals(taskCntrDataLandingQueue.getIsStepPlnmio(), "Y") && !StringUtils.equals(SUCESS_LAND_STATUS, taskCntrDataLandingQueue.getPlnLandFlag())) {
            	 retInfo.setRetCode("2");
                 return retInfo;
            		 }
