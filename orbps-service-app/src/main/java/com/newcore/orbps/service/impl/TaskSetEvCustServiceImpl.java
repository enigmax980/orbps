...
import com.newcore.orbps.service.api.TaskSetEvCustService;

/**
 * @ClassName: TaskSetEvCustServiceImpl
 * @Description: 被保人开户
 * @author jiangbomeng
 * @date 2016年9月1日 上午11:06:50
 * 
 */
@Service("taskSetEvCustService")
public class TaskSetEvCustServiceImpl implements TaskSetEvCustService {
	/**
	 * 日志管理工具实例.
	 */
	private static Logger logger = LoggerFactory.getLogger(TaskSetEvCustServiceImpl.class);
	...
	@Override
	@AsynCall
	public String setEvCust(String args) {
		String[] argsArr = args.split("_");

		// 业务逻辑开始
		logger.info("执行方法:被保人开户" + argsArr[0] + "_" + argsArr[1]);
