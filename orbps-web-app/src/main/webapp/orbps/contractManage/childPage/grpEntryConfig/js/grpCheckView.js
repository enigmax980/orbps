...
com.orbps.contractManage.childPage.grpEntryConfig.CheckViewForm=$("#CheckViewForm");

//基本信息校验规则
com.orbps.contractManage.childPage.grpEntryConfig.grpCheckForm = function (vform) {
...
//	$("*").datagridsInitLoad();
	...
	// 初始化校验信息
	com.orbps.contractManage.childPage.grpEntryConfig.grpCheckForm(com.orbps.contractManage.childPage.grpEntryConfig.CheckViewForm);
	//增加表格
	$("#CheckViewForm #btnAdd").click(function() {
