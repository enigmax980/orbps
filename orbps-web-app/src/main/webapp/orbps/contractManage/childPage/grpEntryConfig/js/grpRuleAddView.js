...
com.orbps.contractManage.childPage.grpEntryConfig.RuleAddForm=$("#RuleAddForm");

//基本信息校验规则
com.orbps.contractManage.childPage.grpEntryConfig.RuleForm = function (vform) {
...
//	$("*").datagridsInitLoad();
	...
	// 初始化校验信息
	com.orbps.contractManage.childPage.grpEntryConfig.RuleForm(com.orbps.contractManage.childPage.grpEntryConfig.RuleAddForm);
	//增加表格
	$("#RuleAddForm #btnAdd").click(function() {
