//applInfo
com.orbps.contractEntry.renewalEntry.atherInfo = $('#atherInfo');
...
$(function() {
    ...
    com.orbps.contractEntry.renewalEntry
            .applInfoValidateForm(com.orbps.contractEntry.renewalEntry.atherInfo);
    ...
    $("#atherInfo #disputeHandling").blur(function() {
        var disputeHandling = $("#disputeHandling").val();
        if (disputeHandling == null || "" == disputeHandling) {
            lion.util.info("警告", "争议处理方式不能为空");
            return false;
        }
    });
