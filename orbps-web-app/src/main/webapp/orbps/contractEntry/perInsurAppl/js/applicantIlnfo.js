...
com.orbps.contractEntry.perInsurAppl.applicantIlnfo = $("#applicantIlnfo");
// 编辑或添加对话框
...
$(function() {
    com.orbps.contractEntry.perInsurAppl
            .handleForm(com.orbps.contractEntry.perInsurAppl.applicantIlnfo);

    // 身份证号验证
    jQuery.validator.addMethod("isIdCardNo", function(value, element) {
        com.orbps.contractEntry.grpInsurAppl.appIdTypeValue = $(
                "#applicantIlnfo #idType").val();
