com.orbps.contractEntry.perInsurAppl.insurInfoForm = $("#insuredInfo");
// 基本信息校验规则
com.orbps.contractEntry.perInsurAppl.insurInfoBaseValidateForm = function (vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.perInsurAppl
            .insurInfoBaseValidateForm(com.orbps.contractEntry.perInsurAppl.insurInfoForm);
});
...
$("#insuredInfo #recognizeeRelation").blur(function() {
