...
$(function() {
    ...
    com.orbps.contractEntry.perInsurAppl
            .handleForm(com.orbps.contractEntry.perInsurAppl.applInfoForm);
    // 点击next
    ...
    // alert(2);
    // var selectData = $("#pollicitation-beneFiciary
    // #fbp-editDataGrid-one").editDatagrids("getSelectRows");
    ...
    // var mainRisk = $("#pollicitation-beneFiciary
    // #fbp-editDataGrid-one").editDatagrids("getSelectRows");
