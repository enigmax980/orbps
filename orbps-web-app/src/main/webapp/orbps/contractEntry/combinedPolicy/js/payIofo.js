//基本信息校验规则
com.orbps.contractEntry.combinedPolicy.paylidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.combinedPolicy
            .paylidateForm(com.orbps.contractEntry.combinedPolicy.payForm);
    ...
    $("#payForm #arbitrationCommissionName").blur(
            function() {
                var arbitrationCommissionName = $("#arbitrationCommissionName")
                        .val();
  ...
  //连续投保下拉框默认显示否
    $("#continuousInsurance").change(function(){
    	$("#continuousInsurance").combo("val", "N");
    });
