//基本信息校验规则
com.orbps.contractEntry.combinedPolicy.recognizeelidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.combinedPolicy
            .recognizeelidateForm(com.orbps.contractEntry.combinedPolicy.recognizeeForm);
    ...
    //是否连带被保人下拉框默认显示否
    $(" #relIpsnFlag").change(function(){
    	$("#relIpsnFlag").combo("val", "N");
    });
    
    //被保人异常告知下拉框默认显示否
    $("#healthStatFlag").change(function(){
    	$("#healthStatFlag").combo("val", "N");
    });
