...
com.orbps.contractEntry.longInsuranceEntry.offerInfoForm = $("#offerInfo");
com.orbps.contractEntry.longInsuranceEntry.appIdTypeValue;
com.orbps.contractEntry.longInsuranceEntry.appConnIdTypeValue;
// 基本信息校验规则
com.orbps.contractEntry.longInsuranceEntry.beneficiaryInfoValidateForm = function(
        vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.longInsuranceEntry
            .beneficiaryInfoValidateForm(com.orbps.contractEntry.longInsuranceEntry.offerInfoForm);
    
    setTimeout(function(){
    	//是否人工核保下拉框默认显示否
    	$("#offerInfo #manualUnderwriting").combo("val","N");
    },1000);
});
