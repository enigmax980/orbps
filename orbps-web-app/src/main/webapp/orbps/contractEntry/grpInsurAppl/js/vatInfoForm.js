com.orbps.contractEntry.grpInsurAppl.vatInfoForm = $("#vatInfoForm");

// 基本信息校验规则
com.orbps.contractEntry.grpInsurAppl.vatValidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.grpInsurAppl
            .vatValidateForm(com.orbps.contractEntry.grpInsurAppl.vatInfoForm);
