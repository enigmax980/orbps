com.orbps.contractEntry.grpInsurAppl.applBaseInfoForm = $("#applBaseInfoForm");
com.orbps.contractEntry.grpInsurAppl.appIdTypeValue;
// 基本信息校验规则
com.orbps.contractEntry.grpInsurAppl.applBaseValidateForm = function(vform) {
...
//联系人固定电话、移动电话不能同时为空
com.orbps.contractEntry.grpInsurAppl.isPhoneOrTel = function() {
...
$(function() {
	...
	com.orbps.contractEntry.grpInsurAppl
			.applBaseValidateForm(com.orbps.contractEntry.grpInsurAppl.applBaseInfoForm);
	...
	jQuery.validator.addMethod("isIdCardNo", function(value, element) {
		...
		if (com.orbps.contractEntry.grpInsurAppl.appIdTypeValue === "I") {
...
$("#applBaseInfoForm #connPhone").blur(function() {
	com.orbps.contractEntry.grpInsurAppl.isPhoneOrTel();
});
