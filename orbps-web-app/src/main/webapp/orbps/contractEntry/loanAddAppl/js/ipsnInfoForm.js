//定义form
com.orbps.contractEntry.loanAddAppl.ipsnInfoForm = $('#ipsnInfoForm');

// 基本信息校验规则
com.orbps.contractEntry.loanAddAppl.ipsnValidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.loanAddAppl
            .ipsnValidateForm(com.orbps.contractEntry.loanAddAppl.ipsnInfoForm);
