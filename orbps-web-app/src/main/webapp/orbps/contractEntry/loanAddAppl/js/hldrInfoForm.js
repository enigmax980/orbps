//定义form
com.orbps.contractEntry.loanAddAppl.hldrInfoForm = $('#hldrInfoForm');

// 基本信息校验规则
com.orbps.contractEntry.loanAddAppl.hldrValidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.loanAddAppl
            .hldrValidateForm(com.orbps.contractEntry.loanAddAppl.hldrInfoForm);
