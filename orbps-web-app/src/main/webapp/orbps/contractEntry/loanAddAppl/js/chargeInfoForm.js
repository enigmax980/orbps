//定义form
com.orbps.contractEntry.loanAddAppl.chargeInfoForm = $('#chargeInfoForm');

// 基本信息校验规则
com.orbps.contractEntry.loanAddAppl.chargeValidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.loanAddAppl
            .chargeValidateForm(com.orbps.contractEntry.loanAddAppl.chargeInfoForm);
