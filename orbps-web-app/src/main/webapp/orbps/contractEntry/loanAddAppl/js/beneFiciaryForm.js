//定义form
com.orbps.contractEntry.loanAddAppl.beneFiciaryForm = $('#beneFiciaryForm');

// 基本信息校验规则
com.orbps.contractEntry.loanAddAppl.beneValidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.loanAddAppl
            .beneValidateForm(com.orbps.contractEntry.loanAddAppl.beneFiciaryForm);
