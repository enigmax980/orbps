//定义form
com.orbps.contractEntry.loanAddAppl.arbitrationInfoForm = $('#arbitrationInfoForm');

// 基本信息校验规则
com.orbps.contractEntry.loanAddAppl.arbiValidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractEntry.loanAddAppl
            .arbiValidateForm(com.orbps.contractEntry.loanAddAppl.arbitrationInfoForm);
