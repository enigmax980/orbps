//定义form
com.orbps.contractEntry.loanAddAppl.submitForm = $('#submitForm');
...
$(function() {
    ...
    $('#submitForm #btnSubmit')
            .click(
                    function() {
                        if (com.orbps.contractEntry.loanAddAppl.applInfoForm
                                .validate().form()
                                && com.orbps.contractEntry.loanAddAppl.vatInfoForm
                                        .validate().form()
                                && com.orbps.contractEntry.loanAddAppl.hldrInfoForm
                                        .validate().form()
                                && com.orbps.contractEntry.loanAddAppl.ipsnInfoForm
                                        .validate().form()
                                && com.orbps.contractEntry.loanAddAppl.arbitrationInfoForm
                                        .validate().form()
                                && com.orbps.contractEntry.loanAddAppl.chargeInfoForm
                                        .validate().form()) {
                            if (validateSelectVal()) {
                                // 获取要约信息下面的所有险种信息
                                var getAddRowsData = $('#polListTb')
                                        .editDatagrids('getRowsData');
                                // 提交方法
                                var LoanAddApplVo = {};
                                LoanAddApplVo.LoanAddApplInfoVo = com.orbps.contractEntry.grpInsurAppl.applInfoForm
                                        .serializeObject();
                                LoanAddApplVo.LoanAddVatInfoVo = com.orbps.contractEntry.grpInsurAppl.vatInfoForm
                                        .serializeObject();
                                LoanAddApplVo.LoanAddHldrInfoVo = com.orbps.contractEntry.grpInsurAppl.applBaseInfoForm
                                        .serializeObject();
                                LoanAddApplVo.LoanAddIpsnInfoVo = com.orbps.contractEntry.grpInsurAppl.proposalInfoForm
                                        .serializeObject();
                                LoanAddApplVo.LoanAddBeneficiaryVo = com.orbps.contractEntry.grpInsurAppl.payInfoForm
                                        .serializeObject();
                                LoanAddApplVo.LoanAddArbitrationInfoVo = com.orbps.contractEntry.grpInsurAppl.specialInsurAddInfoForm
                                        .serializeObject();
                                LoanAddApplVo.LoanAddBsInfoVo = com.orbps.contractEntry.grpInsurAppl.printInfoForm
                                        .serializeObject();
                                LoanAddApplVo.LoanAddChargeInfoVo = com.orbps.contractEntry.grpInsurAppl.printInfoForm
                                        .serializeObject();
                                LoanAddApplVo.insuredGroupModalVos = com.common.insuredList;
                                LoanAddApplVo.organizaHierarModalVos = com.common.oranLevelList;
                                LoanAddApplVo.busiPrdVos = getAddRowsData;
                                var responseVos = new Array();
                                for (var i = 0; i < com.common.oranLevelList.length; i++) {
                                    var array_element = com.common.oranLevelList[i];
                            ...
                            function() {
                                ...
                                if (tagName == 'INPUT') {
                                    if (type == 'radio') {
                                        ...
                                        $('#applicantSaveForm #' + key).val(
                                                value);
                                    }
                                } else if (tagName == 'SELECT'
                                        || tagName == 'TEXTAREA') {
                                    $('#applicantSaveForm #' + key).combo(
                                            'val', value);
                                }
