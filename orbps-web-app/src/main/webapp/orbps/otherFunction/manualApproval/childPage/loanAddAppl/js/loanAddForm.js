...
//treegrid
com.orbps.contractEntry.loanAddAppl.tableId = $('#treegridId');
//编辑或添加对话框
...
com.orbps.contractEntry.loanAddAppl.loanAddForm = $('#loanAddForm');
com.orbps.contractEntry.loanAddAppl.pollicitation=$("#pollicitation_one")
com.orbps.contractEntry.loanAddAppl.busiPrqdCode = null;
//基本信息校验规则
com.orbps.contractEntry.loanAddAppl.handleForm= function (vform) {
...
$(function() {	
	...
	$("#btnNext").click(function() {
		...
		if(com.orbps.contractEntry.loanAddAppl.loanAddForm.validate().form()){
...
//			document.getElementById("btnPrev").click();
	...
	//增加表格
	$("#loanAddFormoffer #btnAdd").click(function() {
		$("#fbp-editDataGrids").editDatagrids("addRows");
	});
	
	//删除表格
	$("#loanAddFormoffer #btnDel").click(function () {  
		$("#fbp-editDataGrids").editDatagrids("delRows");
    }); 
	
	//查询责任信息
	$("#loanAddFormoffer #btnSelect").click(function() {
		var selectData = $("#loanAddFormoffer #fbp-editDataGrids").editDatagrids("getSelectRows");
		...
		com.orbps.contractEntry.loanAddAppl.addDialog.load("/orbps/orbps/contractEntry/loanAddAppl/html/loanAddModel.html",function(){
			alert(1);
			...
			setTimeout(function(){
    			$("#loanAddFormoffer #coverageInfo_list").editDatagrids("selectRows",com.orbps.contractEntry.loanAddAppl.grpInsurApplList);
			},400);		
		});
	});
	 ...
	 $("#btnGoup").click(function() {
		  com.orbps.contractEntry.loanAddAppl.addDialog.empty();
		  com.orbps.contractEntry.loanAddAppl.addDialog.load("/orbps/orbps/contractEntry/grpInsurAppl/html/insuredGroupModal.html",function(){
			  $(this).modal('toggle');
			  $(this).comboInitLoad();
	 ...
	 $("#btnOranLevel").click(function() {
		com.orbps.contractEntry.loanAddAppl.addDialog.empty();
		com.orbps.contractEntry.loanAddAppl.addDialog.load("/orbps/orbps/contractEntry/grpInsurAppl/html/organizaHierarModal.html",function(){
			$(this).modal('toggle');
			// combo组件初始化
			$(this).comboInitLoad();
			$(this).combotreeInitLoad();	
