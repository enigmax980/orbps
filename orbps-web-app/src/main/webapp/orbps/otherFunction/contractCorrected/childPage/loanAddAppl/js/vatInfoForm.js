//定义form
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.vatInfoForm = $('#vatInfoForm');

//基本信息校验规则
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.vatValidateForm= function (vform) {
...
$(function() {	
	// 调用校验方法
	com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.vatValidateForm(com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.vatInfoForm);
