...
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl={};
//编辑或添加对话框
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.addDialog = $('#btnModel');
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.insuredList = new Array();
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.oranLevelList = new Array();
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.grpInsurApplList = new Array();
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.applInfoForm = $('#applInfoForm');

//基本信息校验规则
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.applValidateForm= function (vform) {
...
$(function() {		
	...
	// 初始化校验方法
	com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.applValidateForm(com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.applInfoForm);	
