...
$("#btnSelect").click(function() {
	var selectData = $("#fbp-editDataGrid").editDatagrids("getSelectRows");
	...
	com.orbps.otherFunction.contractCorrected.childPage.renewalEntry.addDialog.load("/orbps/orbps/contractEntry/modal/html/insurRespModal.html",function(){
		$(this).modal('toggle');
		// 初始化edittable组件
