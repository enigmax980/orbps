//基本信息校验规则
com.orbps.otherFunction.contractCorrected.childPage.combinedPolicy.policyHolderlidateForm = function (vform) {
...
$(function(){
	// 初始化校验信息
	com.orbps.otherFunction.contractCorrected.childPage.combinedPolicy.policyHolderlidateForm(com.orbps.otherFunction.contractCorrected.childPage.combinedPolicy.policyHolderForm);
