...
//基本信息校验规则
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.addTaxInfoValidateForm= function (vform) {
...
$(function() {	
	// 校验函数初始化
	com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.addTaxInfoValidateForm(com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.addTaxInfoForm);
