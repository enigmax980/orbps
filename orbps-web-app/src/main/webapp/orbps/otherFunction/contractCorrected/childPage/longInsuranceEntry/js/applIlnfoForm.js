...
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry={};
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.addTaxInfoForm=$("#addTaxInfo");
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.applIlnfoForm=$("#applIlnfo");
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.beneficiaryInfoForm=$("#beneficiaryInfo");
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.insurInfoForm=$("#insurInfo");
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.offerInfoForm=$("#offerInfo");
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.benesList =[];
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.insuredList = new Array();
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.oranLevelList = new Array();


//基本信息校验规则
com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.applIlnfoValidateForm= function (vform) {
...
$(function() {	
	// 校验函数初始化
	com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.applIlnfoValidateForm(com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.applIlnfoForm);
    
	//身份证号验证
	jQuery.validator.addMethod("isIdCardNo", function(value, element) {
		com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.appIdTypeValue = $("#applIlnfo #idNo").val();
		// 先判断证件类型是否为身份证再去校验,appIdTypeValue(证件类型的值)再各自需要的js里设置为全局变量,
		if(com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.appIdTypeValue=="UW"){
...
$("#idNo").blur(function() {
	idcard($("#applIlnfo #paperType"),$("#applIlnfo #idNo"),$("#applIlnfo #birthDate"),$("#applIlnfo #sex"));
});

//当联系人证件类型改变的 时候，将五要素只读变成可写
$("#applIlnfo #paperType").change(function() {
	com.orbps.otherFunction.contractCorrected.childPage.longInsuranceEntry.appConnIdTypeValue = $("#applIlnfo #paperType").val();
