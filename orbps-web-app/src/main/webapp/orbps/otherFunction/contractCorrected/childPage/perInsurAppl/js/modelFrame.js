//com.orbps.otherFunction.contractCorrected.childPage.perInsurAppl.pollicitation=$("#pollicitation-beneFiciary")
//
//$(function() {	
//	// datagrid组件初始化
//	$("*").datagridsInitLoad();
...
//	$("*").comboInitLoad();
//	// 调用校验方法
//	com.orbps.otherFunction.contractCorrected.childPage.perInsurAppl.handleForm(com.orbps.otherFunction.contractCorrected.childPage.perInsurAppl.applInfoForm);
//	// 点击next
//	$("#btnNext").click(function() {
//		
//		if(com.orbps.otherFunction.contractCorrected.childPage.perInsurAppl.applInfoForm.validate().form()){
...
////		com.orbps.otherFunction.contractCorrected.childPage.perInsurAppl.addDialog.load("/orbps/orbps/contractEntry/perInsurAppl/html/insurRespModal.html",function(){
////			$(this).modal('toggle');
////			// combo组件初始化
...
////			setTimeout(function(){
////    			$("#coverageInfo_list").editDatagrids("selectRows",com.orbps.otherFunction.contractCorrected.childPage.perInsurAppl.grpInsurApplList);
////			},400);		
////		});
////	});
//});
