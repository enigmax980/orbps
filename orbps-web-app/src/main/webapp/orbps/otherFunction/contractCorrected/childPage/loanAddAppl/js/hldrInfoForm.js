//定义form
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.hldrInfoForm = $('#hldrInfoForm');

//基本信息校验规则
com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.hldrValidateForm= function (vform) {
...
$(function() {	
	...
	// 调用校验方法
	com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.hldrValidateForm(com.orbps.otherFunction.contractCorrected.childPage.loanAddAppl.hldrInfoForm);
	
	//丢失焦点的非空校验
	$("#hldrInfoForm #custName").blur(function () {  
	...
	$("#hldrInfoForm #idNo").blur(function () {  
		var idNo = $("#idNo").val();
		if(idNo==null||""==idNo){
	...
	$("#hldrInfoForm #postalAddress").blur(function () {  
	...
	$("#hldrInfoForm #postCode").blur(function () {  
	...
	$("#hldrInfoForm #mobilePhone").blur(function () {  
	...
	$("#hldrInfoForm #lanPhone").blur(function () {  
	...
	$("#hldrInfoForm #email").blur(function () {  
		var email = $("#email").val();
		if(email==null||""==email){
	...
	$("#hldrInfoForm #faxNumber").blur(function () {  
	...
	setTimeout(function(){
		//是否覆盖以往信息下拉框默认显示否
		$("#hldrInfoForm #coverInfoFlag").combo("val","N");
	},1000);
});
