com.orbps.contractReview.sgGrpInsurAppl.printInfoForm = $("#printInfoForm");
//基本信息校验规则
com.orbps.contractReview.sgGrpInsurAppl.printValidateForm = function(vform) {
...
$(function() {
 ...
 // 初始化校验函数
    com.orbps.contractReview.sgGrpInsurAppl
            .printValidateForm(com.orbps.contractReview.sgGrpInsurAppl.printInfoForm);
});
