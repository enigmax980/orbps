com.orbps.contractReview.grpInsurAppl.vatInfoForm = $("#vatInfoForm");

// 基本信息校验规则
com.orbps.contractReview.grpInsurAppl.vatValidateForm = function(vform) {
...
$(function() {
    ...
    com.orbps.contractReview.grpInsurAppl
            .vatValidateForm(com.orbps.contractReview.grpInsurAppl.vatInfoForm);
