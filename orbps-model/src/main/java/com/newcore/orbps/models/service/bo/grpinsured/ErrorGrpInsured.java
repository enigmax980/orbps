 ...
 */
public class ErrorGrpInsured implements Serializable {
	/**
	 * 
	 */
	...
	/**
	 * @param ipsnAge the ipsnAge to set
	 */
	...
	/**
	 * @param ipsnMobilePhone the ipsnMobilePhone to set
	 */
