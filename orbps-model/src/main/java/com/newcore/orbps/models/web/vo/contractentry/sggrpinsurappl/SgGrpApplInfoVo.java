 ...
 *
 */
public class SgGrpApplInfoVo implements Serializable {

	private static final long serialVersionUID = 114560000014L;
	...
	/**
	 * @return the previousPolNo
	 */
	public String getPreviousPolNo() {
		return previousPolNo;
	}
	/**
	 * @param previousPolNo the previousPolNo to set
	 */
    ...
    public String toString() {
        return "SgGrpApplInfoVo [applNo=" + applNo + ", quotaEaNo=" + quotaEaNo + ", applDate=" + applDate
                + ", agreementNo=" + agreementNo + ", previousPolNo=" + previousPolNo + ", salesChannel=" + salesChannel
                + ", salesBranchNo=" + salesBranchNo + ", saleCode=" + saleCode + ", saleName=" + saleName
                + ", worksiteNo=" + worksiteNo + ", worksiteName=" + worksiteName + ", polNo=" + polNo + ", polNoState="
                + polNoState + ", effectDate=" + effectDate + ", grpSalesListFormVos=" + grpSalesListFormVos + "]";
    }
