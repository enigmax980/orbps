 ...
 */
public class PlnmioRecVo implements Serializable {
    ...
    public void transBoToVo(PlnmioRec plnmioRec){

        this.setAccCustIdType(plnmioRec.getAccCustIdType());
        this.setAccId(plnmioRec.getAccId());
        this.setAmnt(plnmioRec.getAmnt().doubleValue());
        this.setArcBranchNo(plnmioRec.getArcBranchNo());
        this.setBankaccIdNo(plnmioRec.getAccCustIdNo());

        this.setBankAccName(plnmioRec.getBankAccName());
        this.setBankAccNo(plnmioRec.getBankAccNo());
        this.setBankCode(plnmioRec.getBankCode());
        this.setCgNo(plnmioRec.getCgNo());
        this.setClearingMioTxNo(plnmioRec.getClearingMioTxNo());

        this.setCntrNo(plnmioRec.getCntrNo());
        this.setCurrencyCode(plnmioRec.getCurrencyCode());
        this.setCntrType(plnmioRec.getCntrType());
        this.setFinPlnmioDate(plnmioRec.getFinPlnmioDate());

        this.setHoldFlag(StringUtils.stringToInteger(plnmioRec.getHoldFlag()));
        this.setIpsnNo(plnmioRec.getIpsnNo());
        this.setLockFlag(StringUtils.stringToInteger(plnmioRec.getLockFlag()));
        this.setMgrBranchNo(plnmioRec.getMgrBranchNo());

        this.setMioClass(plnmioRec.getMioClass());
        this.setMioCustName(plnmioRec.getMioCustName());
        this.setMioCustNo(plnmioRec.getMioCustNo());
        this.setMioItemCode(plnmioRec.getMioItemCode());
        this.setMioProcFlag(plnmioRec.getMioProcFlag());

        this.setMioType(plnmioRec.getMioType());
        this.setMtnId(plnmioRec.getMtnId());
        this.setMtnItemCode(plnmioRec.getMtnItemCode());
        this.setMultiPayAccType(plnmioRec.getMultiPayAccType());

        this.setPlnmioCreateTime(plnmioRec.getPlnmioCreateTime());
        this.setPlnmioDate(plnmioRec.getPlnmioDate());
        this.setPlnmioRecId(plnmioRec.getPlnmioRecId());
        this.setPolCode(plnmioRec.getPolCode());
        this.setPremDeadlineDate(plnmioRec.getPremDeadlineDate());

        this.setProcStat(plnmioRec.getProcStat());
        this.setRemark(plnmioRec.getRemark());
        this.setRouterNo(plnmioRec.getRouterNo());
        this.setSalesBranchNo(plnmioRec.getSalesBranchNo());
        this.setSalesChannel(plnmioRec.getSalesChannel());

        this.setSalesNo(plnmioRec.getSalesNo());
        this.setSgNo(plnmioRec.getSgNo());
        this.setSignYear(plnmioRec.getSignYear());
        this.setTransStat(plnmioRec.getTransStat());
        this.setVoucherNo(plnmioRec.getVoucherNo());
