 ...
 *
 */
public class ApprovalSessionModel  implements Serializable{
	
	private static final long serialVersionUID = 14344544586L;
	/** 操作员工号 */
    ...
    /**
     * @param prioBranchNo the prioBranchNo to set
     */
    ...
    /**
     * @param processingCenter the processingCenter to set
     */
    ...
    /**
     * @param printBranchNo the printBranchNo to set
     */
    ...
    /**
     * @param printBranchName the printBranchName to set
     */
    ...
    public String toString() {
        return "ApprovalSessionModel [clerkNo=" + clerkNo + ", name=" + name + ", branchNo=" + branchNo
                + ", branchName=" + branchName + ", prioBranchNo=" + prioBranchNo + ", postCode=" + postCode + ", tel="
                + tel + ", address=" + address + ", email=" + email + ", processingCenter=" + processingCenter
                + ", archiveBranchNo=" + archiveBranchNo + ", printBranchNo=" + printBranchNo + ", printBranchName="
