 ...
 *
 */
public class LongInsurInsurInfoVo  implements Serializable{
	
	private static final long serialVersionUID = 1249444543L;
	...
	public String toString() {
		return "InsurInfo [relToIpsn=" + relToIpsn + ", customerNo=" + customerNo + ", Name=" + Name + ", sex=" + sex
				+ ", birthDate=" + birthDate + ", age=" + age + ", idType=" + idType + ", idNo=" + idNo + ", idTerm="
				+ idTerm + ", nationality=" + nationality + ", occupationCode=" + occupationCode + ", occupationType="
				+ occupationType + ", maritalStatus=" + maritalStatus + ", ptJobCode=" + ptJobCode + ", ptJobType="
				+ ptJobType + ", workUnit=" + workUnit + ", officePhone=" + officePhone + ", posAddress=" + posAddress
				+ ", email=" + email + ", mobilePhone=" + mobilePhone + ", zipCode=" + zipCode
