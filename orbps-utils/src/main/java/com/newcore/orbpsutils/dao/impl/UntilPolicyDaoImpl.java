    ...
    public int pGetChkChr(char str[]) {
        ...
        if (str.length <= 0) {
            ...
            for (int i = 1; i <= str.length; i++) {
                subChkStr = str[i - 1];
                if (subChkStr == '0' || subChkStr == '1' || subChkStr == '2') {
                    ascStr = (short) subChkStr;
                } else if (subChkStr == '3' || subChkStr == '4' || subChkStr == '5') {
                    ascStr = (short) subChkStr;
                } else if (subChkStr == '6' || subChkStr == '7' || subChkStr == '8') {
                    ascStr = (short) subChkStr;
                } else if (subChkStr == '9') {
                    ascStr = (short) subChkStr;
                } else if (Character.toUpperCase(subChkStr) == 'A') {
                    ascStr = 65;
                } else if (Character.toUpperCase(subChkStr) == 'B') {
                    ascStr = 66;
                } else if (Character.toUpperCase(subChkStr) == 'C') {
                    ascStr = 67;
                } else if (Character.toUpperCase(subChkStr) == 'D') {
                    ascStr = 68;
                } else if (Character.toUpperCase(subChkStr) == 'E') {
                    ascStr = 69;
                } else if (Character.toUpperCase(subChkStr) == 'F') {
                    ascStr = 70;
                } else if (Character.toUpperCase(subChkStr) == 'G') {
                    ascStr = 71;
                } else if (Character.toUpperCase(subChkStr) == 'H') {
                    ascStr = 72;
                } else if (Character.toUpperCase(subChkStr) == 'I') {
                    ascStr = 73;
                } else if (Character.toUpperCase(subChkStr) == 'J') {
                    ascStr = 74;
                } else if (Character.toUpperCase(subChkStr) == 'K') {
                    ascStr = 75;
                } else if (Character.toUpperCase(subChkStr) == 'L') {
                    ascStr = 76;
                } else if (Character.toUpperCase(subChkStr) == 'M') {
                    ascStr = 77;
                } else if (Character.toUpperCase(subChkStr) == 'N') {
                    ascStr = 78;
                } else if (Character.toUpperCase(subChkStr) == 'O') {
                    ascStr = 79;
                } else if (Character.toUpperCase(subChkStr) == 'P') {
                    ascStr = 80;
                } else if (Character.toUpperCase(subChkStr) == 'Q') {
                    ascStr = 81;
                } else if (Character.toUpperCase(subChkStr) == 'R') {
                    ascStr = 82;
                } else if (Character.toUpperCase(subChkStr) == 'S') {
                    ascStr = 83;
                } else if (Character.toUpperCase(subChkStr) == 'T') {
                    ascStr = 84;
                } else if (Character.toUpperCase(subChkStr) == 'U') {
                    ascStr = 85;
                } else if (Character.toUpperCase(subChkStr) == 'V') {
                    ascStr = 86;
                } else if (Character.toUpperCase(subChkStr) == 'W') {
                    ascStr = 87;
                } else if (Character.toUpperCase(subChkStr) == 'X') {
                    ascStr = 88;
                } else if (Character.toUpperCase(subChkStr) == 'Y') {
                    ascStr = 89;
                } else if (Character.toUpperCase(subChkStr) == 'Z') {
                    ascStr = 90;
                } else if (subChkStr == '!') {
                    ascStr = 33;
                } else {
                ...
                modValue = (short) (i % 4);
                if (modValue == 1) {
                    cnt = (short) (cnt + ascStr * 3);
                } else if (modValue == 2) {
                    cnt = (short) (cnt + ascStr * 1);
                } else if (modValue == 3) {
                    cnt = (short) (cnt + ascStr * 9);
                } else if (modValue == 0) {
                    cnt = (short) (cnt + ascStr * 7);
                }
            }//对10取余，返回结果
